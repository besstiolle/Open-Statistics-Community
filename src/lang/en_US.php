...
$lang['allow_send_cms_version'] = 'Envoyer la version de Cms Made Simple';
$lang['allow_send_module_version'] = 'Envoyer la version de tous les modules';
$lang['allow_send_config_information'] = 'Envoyer ma configuration de Cms Made Simple';
$lang['allow_send_php_information'] = 'Envoyer la configuration PHP';
$lang['allow_send_server_information'] = 'Envoyer la configuration serveur';
...
$lang['moddescription'] = 'Ce module un &eacute;metteur anonyme de statistique d\'utilisation de cmsmadesimple. + d\'info sur la page du projet';

$lang['changelog'] = '<ul>
	<li>Version 0.0.1, 06 Juillet 2010 | Bess</li>
	<ul>
	   <li>mise en place sommaire du projet client</li>
	</ul>
</ul>
';
